...
const sections: Section[] = [
    ...
    items: [
      {
        ...
        description: "• Design and optimize RAG-based AI solutions to enhance knowledge retrieval accuracy and system performance\n• Build end-to-end AI prototypes using LLMs and vector databases, translating business requirements into production-ready solutions\n• Collaborate with cross-functional teams to define use cases, select models, and drive AI solutions to production"
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        title: "Onechain Anime Vault",
        description: "A decentralized marketplace for tokenizing and trading anime merchandise as NFTs on OneChain OCT (Sui fork blockchain).",
        prize: "3rd Place - OneHack 2025 ($1500)"
      },
      {
        title: "Crossfi Quest",
        description: "The app leverages quest-based tasks and real rewards to motivate learning, experimentation, and adoption.",
        prize: "5th Place - CrossFi Hackathon #2 ($1000)"
      },
      {
        title: "Bob Roast Machine",
        description: "Revolutionizing comedy through AI-powered roasts and humor generation, making everyone laugh while pushing the boundaries of artificial intelligence.",
        prize: "Pool Prize - Eolas x Algo: Agent Skills Hackathon ($500)"
      },
      {
        title: "Radiator Springs Data Marketplace",
        description: "A Pixar Cars-themed decentralized marketplace for vehicle data.",
        prize: "4th Place - DePIN for Car Data by DeCharge Network ($500)"
      },
      {
        title: "Somnia Battleship on Chain",
        description: "Decentralized battleship supporting trustless multiplayer and automated prize distribution via smart contracts.",
        prize: "Somnia Mini Games Hackathon"
      }
    ]
  },
  {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {section.items.map((item, itemIndex) => (
                <motion.div
                  ...
                  className={`glass-card p-6 ${section.title === "2025 Achievements" ? "achievement-card blockchain-glow" : "card-hover"} relative z-10`}
                >
                  {'image' in item && (
                  ...
                  {'prize' in item && item.prize && (
                    <div className="mb-3">
                      <span className="inline-flex items-center px-3 py-1 rounded-full bg-gradient-to-r from-brand-purple/30 to-brand-light/20 text-brand-light text-sm font-medium border border-brand-purple/30 animate-pulse">
                        🏆 {item.prize}
                      </span>
                    </div>
                  )}
